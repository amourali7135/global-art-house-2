class LessonsController < ApplicationController
  ...
  def lesson_params
    params.require(:lesson).permit(:title, :description, :photo, :subdescription, :photo_cache, :learnings, :rating, :students, :prerequisites, :free, :price_cents, :slug, tag_list: [])
  end
end
