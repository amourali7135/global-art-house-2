class ArtistsController < ApplicationController
  ...
  def artist_params
    params.require(:artist).permit( :first_name, :last_name, :photo, :artist_name, :photo, :bio, :age, :languages_spoken, :instagram, :facebook, :website, :birth_place, :city, :country, :longitude, :latitude, :user, :user_id, :slug, :form, form: [], tag_list: [] )
  end
